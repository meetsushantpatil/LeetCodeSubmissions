...
# Approach -   
# Keep 2 pointers, left & right. If it finds non-alphanumeric, go ahead for left or right. If matches, go ahead, else break && return False.
# Code
# Test
# Optimisation
...
class Solution:
    def isPalindrome(self, s: str) -> bool:
        ...
        if len(s) < 2:  # ["tsT"],  ["car ac"], ["#*aba"], "c"
            return True
        
        left_ptr = 0 # 0, 0, 0, 0
        right_ptr = len(s)-1 # 2, 5, 4, 29
